...
const experienceData = [
  {
    ...
    description:
      "Construcción de aplicaciones web modernas, escalables y responsivas.",
  ...
  },
  {
    ...
    description:
      "Apps nativas con arquitecturas limpias e integración de hardware.",
  ...
  },
  {
    ...
    description:
      "Conexión entre el mundo físico y digital mediante microcontroladores.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight uppercase">
            Experiencia{" "}
            <span className="text-muted-foreground text-2xl md:text-4xl normal-case font-light">
              & Habilidades
            </span>
          </h2>
        </motion.div>
